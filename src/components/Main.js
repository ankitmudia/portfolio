                ...
                <div className="flex flex-col justify-center sm:w-[70%] w-full sm:mr-5">
                    ...
                    <blockquote className="font-[800] text-[2rem] text-[#ec6e59;] mt-[-10px] lg:text-[2.4rem] md:text-[2rem] tm:text-[2.5rem] sm:text-[1rem]">
                        ...
                        <span className="before:block mx-4 mb-6 mt-4 before:absolute before:-inset-2 before:-skew-y-[3deg] before:bg-[#ec6e59;] relative inline-block">
                            <span className="relative text-[#fffffff0] dark:text-[#20262E]">Ankit</span>
                        </span>
                    </blockquote>
                    ...
                    Versatile Software Engineer with a B.Tech in Information Technology from Guru Gobind Singh Indraprastha University. Passionate about leveraging problem-solving skills to contribute to innovative solutions and committed to driving growth
                    and excellence in technology and software development.

                    Tech Stack: JavaScript, ReactJS, Redux, Html5, Css3, Java, Spring Boot, NextJS, Git. 
                    </p>
