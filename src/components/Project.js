...
function Projects({ image, name, live, source, desc, isDarkMode }) {
    return (
            ...
            <div className='w-full sm:w-1/2'>
                <div className='flex flex-col gap-2'>
                    ...
                    <div className='flex gap-5 mt-7'>
                        ...
                        <a href={source} target='_blank' rel='noreferrer' className={`flex items-center gap-1 px-4 py-2 border rounded-md text-sm 
